      ...
      <main className="max-w-2xl mx-auto px-6 py-12 text-center">
        {isConfirmed ? (
          <div>
            ...
            <div className="bg-blue-50 rounded-xl p-6 text-left">
              ...
              <p className="text-cyan-700 font-medium mb-4">
                Starttijd: {product.start_time ? product.start_time.substring(0, 5) : ''} - Aanwezig om {product.arrive_time ? product.arrive_time.substring(0, 5) : product.start_time ? product.start_time.substring(0, 5) : ''}
              </p>
          ...
          <div>
            ...
            <a href="/boek" className="px-6 py-3 bg-cyan-700 text-white rounded-xl font-medium">
              Opnieuw boeken
            </a>
          </div>
        )}
