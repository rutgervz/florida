...
function ConfirmationContent() {
  ...
  if (loading) {
    return (<div className="min-h-screen bg-cream flex items-center justify-center"><div className="text-center"><p className="text-gray-500">Betaling wordt verwerkt...</p></div></div>)
  }
  if (!reservation) {
    return (<div className="min-h-screen bg-cream flex items-center justify-center"><div className="text-center"><p className="text-gray-500">Reservering niet gevonden.</p></div></div>)
  }
            ...
            <div className="bg-blue-50 rounded-xl p-6 text-left">
              ...
              <div className="border-t border-cyan-200 pt-3 mb-3">
                {reservation.riders.map((r: any, i: number) => (
                  <p key={i} className="text-gray-600 text-sm py-1">{r.name} - {r.age} jr - {r.weight} kg</p>
                ))}
              </div>
...
export default function ConfirmationPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-cream flex items-center justify-center"><div className="text-center"><p className="text-gray-500">Laden...</p></div></div>}>
      <ConfirmationContent />
    </Suspense>
  )
}
