...
export default function BookingPage() {
  ...
  function renderStep3() {
    ...
    // Experience check: map experience to gaits
    const experienceGaits: Record<string, string[]> = {
      beginner: ['stap'],
      gevorderd: ['stap', 'draf'],
    ...
    const allValid = riders.length > 0 && riders.every(r =>
      r.name &&
      r.age >= selectedProduct.min_age &&
      r.weight > 0 &&
      r.weight <= selectedProduct.max_weight_adult &&
      r.experience &&
      hasEnoughExperience(r.experience)
    )
          ...
          <div key={i} className="bg-white rounded-xl p-5 shadow-sm mb-4">
            ...
            <div className="mt-3">
              ...
              <select
                ...
                className={'w-full md:w-1/2 px-3 py-2 rounded-lg bg-gray-50 border focus:outline-none ' +
                  (rider.experience && !hasEnoughExperience(rider.experience) ? 'border-red-400 focus:border-red-500' : 'border-gray-200 focus:border-cyan-700')
                }
              >
